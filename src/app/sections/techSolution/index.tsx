  ...
  const service_provider_card_data = [
    {
      ...
      card_para:
        "Business collaboration fosters synergy, enhances communication, and drives innovation by aligning teams and sharing resources for optimal success.",
    },
    {
      strip_color: "bg-[#ff5f34]",
      card_head: "Engineering & Services",
      card_para:
        "Engineering and services combine expertise to deliver innovative solutions, optimize performance, and ensure reliable outcomes for complex projects and operations.",
    },
    {
      strip_color: "bg-[#24b78f]",
      card_head: "Creative Minds",
      card_para:
        "Creative minds drive innovation by thinking outside the box, generating unique ideas, and transforming concepts into impactful solutions and designs.",
    },
    {
      strip_color: "bg-[#ff1249]",
      card_head: "Revenue Generation",
      card_para:
        "Revenue generation strategies focus on maximizing income through optimized sales processes, strategic marketing, and innovative business models to drive growth and profitability.",
    },
  ];
    ...
    <>
      <section className="flex flex-col -z-10 relative  container-fluid w-full items-center justify-center">
        ...
        <div className="container relative z-20 flex flex-col items-center w-full">
          ...
          <Image
            ...
            alt="Three people are gathered around a desk, looking at code on a computer monitor in a modern office setting."
          ...
          <Image
            ...
            alt="Red abstract graphic with right-facing arrow patterns – modern vector design element"
          ...
          <Image
            draggable={false}
            className="object-contain hidden lg:flex me-36 absolute -bottom-12"
            src="/images/pngs/14.png"
            alt="Black abstract dots graphic – modern vector design element"
      ...
      <section className="flex flex-col relative pt-20 lg:pt-40 md:mb-40 lg:mb-20 xl:mb-20 container-fluid w-full items-center justify-center">
        <Image
          ...
          alt="Abstract, amorphous light blue shape on a black background, evoking a sense of fluidity and modern design."
        />
        ...
        <div className="container relative flex flex-col items-center w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 items-center justify-center md:justify-between w-full">
            {service_provider_card_data.map((card, index) => (
              <div
                key={index}
                className="bg-black/80 hover:bg-white/60 group z-30 transition mx-auto lg:mx-0 w-[95%] lg:w-full ease-in-out duration-200 flex flex-col lg:flex-row items-center lg:items-start service-provider-card relative shadow-lg rounded-xl py-5 px-2 sm:px-10"
              >
                <>
                  <div
                    className={`h-auto absolute start-[0.4px] w-[8px] rounded-tl-xl rounded-bl-xl inset-0 transition-opacity opacity-0 group-hover:opacity-100 ${card.strip_color}`}
                  ></div>

                  {card.card_head === "Business Collaboration" ? (
                    <svg
                      className="mb-5 lg:mb-0 w-[80px] h-[80px] lg:w-[135px] lg:h-[135px] xl:w-[105px] xl:h-[105px]"
                  ...
                  <div className="ps-5">
                    <h4 className="text-gray-300 group-hover:text-black font-semibold">
                      {card.card_head}
                    </h4>
                    <p className="text-gray-300 group-hover:text-black text-[14px] pt-2 font-medium">
                      {card.card_para}
                    </p>
                  </div>
                </>
