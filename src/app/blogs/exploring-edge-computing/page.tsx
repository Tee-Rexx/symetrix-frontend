...
const BlockchainBeyondBitcoin = () => {
  ...
  useEffect(() => {
    document.title = "Exploring Edge Computing | Naxiums";
              updateDocumentDescription(EXPLORING_EDGE_COMPUTING_PAGE_DESCRIPTION)
    
  }, []);
  return (
    <>
    <div className="container-fluid mx-auto exploring-blog-bg banner-bg-specs py-32 w-full items-center justify-center flex relative">
