...
export const CarouselSlider = ({slider_data, settings} : carousel) => {
    ...
    return (
        <Slider className="flex w-full items-start text-left " {...settings}>
              ...
              <div key={index} className="carousel-card items-start px-3 flex-col float-start text-left drop-shadow-xl hover:bg-gray-300 duration-300 bg-white rounded-md">
