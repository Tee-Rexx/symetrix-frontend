      ...
      <section className="text-gray-600 body-font">
        ...
        <div className="container w-full mx-auto">
          <div className="relative text-center px-5 sm:px-32 py-32  text-gray-100">
            ...
            <p className="mb-6 text-lg sm:text-xl leading-relaxed text-gray-300">
              Explore our portfolio and see how we&apos;ve helped businesses
              achieve their digital transformation goals. At{" "}
              <span className="font-bold">Naxiums</span>, we unlock the full
          ...
          <div className="relative flex w-full">
            <div className="flex flex-col">
              ...
              <span className=" w-full px-3 md:px-0 text-center sm:text-left sm:mx-0 lg:w-3/6 mt-12 mb-8 md:mt-7 md:mb-3 text-gray-100">
                Turn your ideas into innovative solutions! Whether it&apos;s an
                app, a website, or a custom digital product, our passionate team
                is here to make it happen. With cutting-edge technology and a
                focus on excellence, we’ll bring your vision to life and help it
