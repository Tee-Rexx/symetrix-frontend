...
import {NomralNextButton, NormalPrevButton} from "../components/carouselButtons";
...
const Page: React.FC = () => {
  ...
  const cards: Card[] = [
    {
      ...
      description: "Maximize efficiency with our cloud services. Expert migration, robust security, and scalable solutions for your business.",
      button: "Read More",
    },
    {
      img: "/images/card2.jpg",
      title: "Web Development and Optimization",
      description: "Enhance your online presence. Custom web development, responsive design, and seamless CMS integration.",
      button: "Read More",
      },
    {
      img: "/images/card3.jpg",
      title: "Mobile App Development",
      description: "Empower your business with tailored mobile solutions for iOS, Android, and cross-platform needs.",
      button: "Read More",
    ...
    },
    {
      ...
      description: "Strategize with our IT experts. Align technology with business goals for sustainable growth and innovation.",
      button: "Read More",
  ...
  return (
    <>
            ...
            >
              ...
              
              {
                card.title === 'Cloud Solutions' ? (
                  ...
                  <path fill="url(#gradient)" d="M260-160q-91 0-155.5-63T40-377q0-78 47-139t123-78q25-92 100-149t170-57q117 0 198.5 81.5T760-520q69 8 114.5 59.5T920-340q0 75-52.5 127.5T740-160H260Zm0-80h480q42 0 71-29t29-71q0-42-29-71t-71-29h-60v-80q0-83-58.5-141.5T480-720q-83 0-141.5 58.5T280-520h-20q-58 0-99 41t-41 99q0 58 41 99t99 41Zm220-240Z"/>
                </svg>  
                ) : ''
              }
              {
              ...
              }
              {
                card.title === 'Mobile App Development' ? (
                  ...
                  <path fill="url(#gradient2)" d="M280-40q-33 0-56.5-23.5T200-120v-720q0-33 23.5-56.5T280-920h400q33 0 56.5 23.5T760-840v720q0 33-23.5 56.5T680-40H280Zm0-120v40h400v-40H280Zm0-80h400v-480H280v480Zm0-560h400v-40H280v40Zm0 0v-40 40Zm0 640v40-40Z"/>
                </svg> 
                ) : ''
              }
              {
                card.title === 'IT Consulting and Strategy' ? (
                  ...
                  <path fill="url(#gradient3)" d="M0-240v-63q0-43 44-70t116-27q13 0 25 .5t23 2.5q-14 21-21 44t-7 48v65H0Zm240 0v-65q0-32 17.5-58.5T307-410q32-20 76.5-30t96.5-10q53 0 97.5 10t76.5 30q32 20 49 46.5t17 58.5v65H240Zm540 0v-65q0-26-6.5-49T754-397q11-2 22.5-2.5t23.5-.5q72 0 116 26.5t44 70.5v63H780Zm-455-80h311q-10-20-55.5-35T480-370q-55 0-100.5 15T325-320ZM160-440q-33 0-56.5-23.5T80-520q0-34 23.5-57t56.5-23q34 0 57 23t23 57q0 33-23 56.5T160-440Zm640 0q-33 0-56.5-23.5T720-520q0-34 23.5-57t56.5-23q34 0 57 23t23 57q0 33-23 56.5T800-440Zm-320-40q-50 0-85-35t-35-85q0-51 35-85.5t85-34.5q51 0 85.5 34.5T600-600q0 50-34.5 85T480-480Zm0-80q17 0 28.5-11.5T520-600q0-17-11.5-28.5T480-640q-17 0-28.5 11.5T440-600q0 17 11.5 28.5T480-560Zm1 240Zm-1-280Z"/>
                </svg> 
                ) : ''
              }
              </div>
      ...
      <Slider className="flex container justify-center relative text-left" {...settings}>
  {projects.map((project:any, index:any) => (
    ...
    >
      <div className="projects-link-button-container">
        <a href={project.url} className="projects-link-button shadow-lg">
